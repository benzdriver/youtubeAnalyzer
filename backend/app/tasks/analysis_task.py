...
async def run_analysis(task_id: str):
    ...
    async with AsyncSessionLocal() as db:
        ...
        try:
            ...
            await send_progress_update(task_id, 10, "获取视频基本信息", "获取视频信息")
            ...
            await send_progress_update(task_id, 30, "下载视频音频文件", "下载音频文件")
            ...
            await send_progress_update(task_id, 60, "提取视频评论数据", "获取评论数据")
            ...
            await send_progress_update(task_id, 75, "开始音频转录", "转录音频内容")
            ...
            await send_progress_update(task_id, 85, "开始评论分析", "分析评论数据")
            ...
            comment_analysis_result = await analyze_comments_task(
            ...
            extraction_result = {
                ...
                "comment_analysis": comment_analysis_result,
                "extraction_metadata": {
