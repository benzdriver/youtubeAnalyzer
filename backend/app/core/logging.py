...
def setup_logging() -> None:
    ...
    if settings.log_container_info:
        ...
        logger.info("Container logging initialized", extra={
...
def log_container_health(service_name: str, status: str, details: Optional[Dict[str, Any]] = None) -> None:
...
def log_database_connection(status: str, database_url: str, error: Optional[str] = None) -> None:
