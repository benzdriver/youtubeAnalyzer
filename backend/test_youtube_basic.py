...
def test_duration_parsing():
    ...
    for duration_str, expected_seconds in test_cases:
        try:
            ...
            ), f"Expected {expected_seconds}, got {result}"
        except Exception as e:
...
def test_invalid_urls():
    ...
    invalid_urls = ["https://example.com", "not_a_url", "https://youtube.com/watch", ""]
...
def main():
    ...
    try:
        tests = [test_video_id_extraction, test_duration_parsing, test_invalid_urls]
        ...
        if all_passed:
            ...
            print(
                "Note: API-dependent tests (video info, audio download, comments) require YouTube API key"
            )
        else:
            print("\n✗ Some tests failed!")
            return 1
